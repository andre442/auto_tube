...
def parse_arguments():
    ...
    parser.add_argument('--sd_model', type=str, default='a', help='Modelo a ser usado do SD (default: flux_dev)')
    ...
    parser.add_argument('--v_width', type=int, default=1280, help='largura do vídeo (default: 720)')
    ...
    parser.add_argument('--voice_speed', type=float, default=1.0, help='velocidade da voz de narração')
...
async def generate_image(prompt, filename, negative_prompt="", data_dir="data"):
    ...
    try:
        ...
        art_style = (
            "hand-painted look, hand-drawn textures, lofi aesthetic"
        )
...
async def text_to_speech_coqui(text, filename, velocidade=1.0):
    ...
    if velocidade != 1.0:
        try:
            ...
            temp_file = filename.replace(".wav", f"_temp_{velocidade}.wav")
